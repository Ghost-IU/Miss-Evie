...
import miss_evie.modules.sql.global_bans_sql as sql
...
from miss_evie.modules.helper_funcs.chat_status import user_admin, is_user_admin
...
from miss_evie.modules.sql.users_sql import get_all_chats
...
def __user_info__(user_id):
    ...
    if is_gbanned:
        ...
        if user.reason:
            ...
            text += "\n\nAppeal at @miss_eviebot if you think it's invalid."
    else:
        text = text.format("No")
    return text
...
miss_evie will constantly help banning spammers off from your group automatically So, you don't have to worry about spammers storming your group[.](https://telegra.ph/file/c1051d264a5b4146bd71e.jpg)
"""
