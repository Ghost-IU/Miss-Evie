...
def gtrans(update, context):
    ...
    if msg.reply_to_message:
        if msg.reply_to_message.text:
            ...
            translate_text = msg.reply_to_message.caption
        else:
            return
...
def gtts(update, context):
    ...
    try:
        tts = gTTS(reply)
        tts.save("miss_evie.mp3")
        with open("miss_evie.mp3", "rb") as speech:
            msg.reply_audio(speech)
    finally:
        if os.path.isfile("miss_evie.mp3"):
            os.remove("miss_evie.mp3")
