...
import miss_evie.modules.sql.notes_sql as sql
from miss_evie import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from miss_evie.__main__ import DATA_IMPORT
from miss_evie.modules.helper_funcs.chat_status import user_admin
from miss_evie.modules.helper_funcs.alternate import typing_action

# from miss_evie.modules.rules import get_rules
import miss_evie.modules.sql.rules_sql as rulessql

# from miss_evie.modules.sql import warns_sql as warnssql
import miss_evie.modules.sql.blacklist_sql as blacklistsql
from miss_evie.modules.sql import disable_sql as disabledsql

# from miss_evie.modules.sql import cust_filters_sql as filtersql
# import miss_evie.modules.sql.welcome_sql as welcsql
import miss_evie.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    f = open("miss_evie{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("miss_evie{}.backup".format(chat_id), "rb"),
        caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `miss_evie-Backup` is specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("miss_evie{}.backup".format(chat_id))  # Cleaning file
